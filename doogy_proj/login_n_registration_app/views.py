    ...
    def post(self, request):
        if 'register' in request.POST:
            ...
            user = User.objects.create(
                first_name=request.POST['first_name'], last_name=request.POST['last_name'], email=request.POST['email'], password=password)
...
def success(request, user_id):
    ...
    return redirect(f"/home") if request.session['user_id'] == user_id else redirect("/")
